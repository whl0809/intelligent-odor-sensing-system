...
This command enables the ADS7828 TGS array and the SVM41 UART module (for
temperature and humidity). SHT45, NH3, and H2S are explicitly disabled and
are neither initialized nor logged. It waits 60 seconds, averages the latest 10 raw readings from TGS2603,
