...
with the ECE450 sensor acquisition wiring.
...
Repository location:
    ECE450_software/pipeline/co5300_qspi_test.py

Examples:
    sudo python3 pipeline/co5300_qspi_test.py --self-test
    sudo python3 pipeline/co5300_qspi_test.py \
        --init pipeline/config/co5300_init.json --pattern bars --hold
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--init",
        default=PIPELINE_DIR / "config" / "co5300_init.json",
    )
